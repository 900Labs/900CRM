...
This sprint is limited to public docs, package metadata, workspace Cargo metadata, and the app-visible Settings GitHub link. It does not change product behavior, dependencies, lockfiles, schema, MCP, AI, sync server, release packaging, or CI semantics.
...
- Existing current public self-links used non-canonical hyphenated and lowercase owner-repo variants.
